      ...
      <div className="max-w-4xl mx-auto">
        ...
        >
            ...
            <div className="p-6 bg-card border border-border rounded-2xl">
              <div className="flex items-center justify-center gap-4">
                ...
                <div className="text-left">
                  ...
                  <p className="text-foreground font-medium">Istanbul, Turkey</p>
                </div>
              </div>
            </div>
          </div>
          ...
          <a
            ...
            className="inline-flex items-center gap-3 px-8 py-4 bg-primary text-primary-foreground font-medium rounded-lg transition-all duration-300 hover:shadow-[0_0_30px_rgba(100,200,220,0.4)]"
          >
