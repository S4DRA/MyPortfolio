        ...
        >
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6 mb-8 sm:mb-12">
            <a
              ...
              className="group p-4 sm:p-6 bg-card border border-border rounded-2xl transition-all duration-300 hover:border-primary/50 hover:shadow-[0_0_30px_rgba(229,231,235,0.14)]"
            >
              <div className="flex flex-col items-center justify-center gap-3 sm:flex-row sm:gap-4">
                <svg
                  className="h-5 w-5 text-primary transition-all group-hover:drop-shadow-[0_0_8px_rgba(229,231,235,0.35)] sm:h-6 sm:w-6"
                  fill="none"
                  stroke="currentColor"
                  viewBox="0 0 24 24"
                >
            ...
            >
              <div className="flex flex-col sm:flex-row items-center justify-center gap-3 sm:gap-4">
                <svg
                  className="w-5 h-5 sm:w-6 sm:h-6 text-primary group-hover:drop-shadow-[0_0_8px_rgba(229,231,235,0.35)] transition-all flex-shrink-0"
                  fill="none"
                  stroke="currentColor"
                  viewBox="0 0 24 24"
                >
          ...
          <a
            ...
            className="inline-flex items-center justify-center gap-2 sm:gap-3 px-6 py-3 sm:px-8 sm:py-4 bg-primary text-primary-foreground font-medium rounded-lg transition-all duration-300 hover:shadow-[0_0_30px_rgba(229,231,235,0.24)] text-sm sm:text-base"
          >
