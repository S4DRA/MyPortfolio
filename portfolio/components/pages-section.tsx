    ...
    <section id="pages" className="relative px-4 py-16 sm:px-6 sm:py-24 md:py-28">
      <div className="mx-auto max-w-6xl">
        <div className="mb-8 flex items-center gap-3 sm:mb-12 sm:gap-4">
          <span className="font-mono text-xs text-muted-foreground sm:text-sm">01.</span>
          <h2 className="text-xl text-foreground sm:text-3xl md:text-4xl">Portfolio Pages</h2>
